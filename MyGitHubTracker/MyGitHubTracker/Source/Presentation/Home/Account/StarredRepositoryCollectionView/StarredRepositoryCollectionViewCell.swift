//
//  StarredRepositoryCollectionViewCell.swift
//  MyGitHubTracker
//
...
final class StarredRepositoryCollectionViewCell: UICollectionViewCell, ViewType {
...
private extension StarredRepositoryCollectionViewCell {
    func configureUI() {
